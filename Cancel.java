...
public class Cancel extends JFrame implements ActionListener{
    ...
    JTextField  tfpnr;
    JLabel tfname, cancelllationno , lblfcode, lbldateoftravel;
    ...
    public Cancel(){
        ...
        cancelllationno = new JLabel("" + random.nextInt(1000000));
        cancelllationno .setBounds(220,180,150,25);
        add(cancelllationno );
    ...
    public void actionPerformed(ActionEvent ae){
      if(ae.getSource() == fetchButton){
        ...
        String pnr = tfpnr.getText();
        String cancelno = cancelllationno.getText();
